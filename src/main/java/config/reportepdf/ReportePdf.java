...
import static config.Constants.pathPdf;
...
public class ReportePdf {
    ...
    public static void crearPortada() {
            ...
            Image imagen;
            try {
                imagen = new Image(ImageDataFactory.create(System.getProperty("user.dir") + "\\src\\main\\java\\config\\reportepdf\\tsoft.png"));
